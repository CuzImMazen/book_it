...
// }
import 'package:book_it/core/utils/helpers.dart';
import 'package:book_it/core/utils/status_localization.dart';
import 'package:book_it/features/History/data/model/book_model.dart';
import 'package:flutter/material.dart';
...
class BookDateAndStatusRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final statusColor = getStatusColor(book.status);
    ...
    return Row(
      ...
      children: [
        ...
        Padding(
          padding: const EdgeInsets.only(right: 10.0),
          child: Text(
            formatBookingDates(context, book.startDate, book.endDate),
            textAlign: TextAlign.end,
            style: TextStyle(fontWeight: FontWeight.w900, fontSize: 14),
          ),
        ),
          ...
          child: Container(
            ...
            child: Center(
              child: Padding(
                ...
                child: Text(
                  localizedStatus(context, book.status),
                  style: TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.bold,
                    color: statusColor,
