...
class CreatePropertyView2 extends StatefulWidget {
  const CreatePropertyView2({super.key});

  @override
  State<CreatePropertyView2> createState() => _CreatePropertyView2State();
}

class _CreatePropertyView2State extends State<CreatePropertyView2> {
            ...
            child: Form(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _header("Numbers", "Set your price and size"),
                  Row(
